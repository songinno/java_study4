...
public class MenuManagementProgram5 {
...
//              }
                ...
                if (Arrays.toString(temp).equals(Arrays.toString(salesNum))) {
                    ...
                    System.out.printf("=> %s (매출량: %d)\n", menuList[maxIdx][1], max);
                }
                System.out.println("");
                ...
                int min = 99; // 매출량 기록 변수
                int minIdx = -1; // 매출량 꼴지 메뉴의 인덱스
